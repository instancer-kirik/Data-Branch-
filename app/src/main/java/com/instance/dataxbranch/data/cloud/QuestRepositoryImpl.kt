...
//
    ...
    override fun getQuestsFromCloud(): Flow<Response<List<Quest>>> = callbackFlow {
...
//        }
    ...
    override fun addQuestToCloud(title: String, description
...
//        }
    ...
    override fun addQuestToCloud(quest: Quest): Flow<Response<Void?>> = flow {
//        try {
//            emit(Response.Loading)
//            val id = quest.qid
//
...
//        }
    ...
    override fun deleteQuestFromCloud(qid: String): Flow<Response<Void?>> = flow {
//        try {
//            emit(Response.Loading)
