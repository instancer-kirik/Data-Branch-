...
class LinearGradient constructor(
    ...
    private fun getGradientCoordinates(size: Size): Pair<Offset, Offset> {
        ...
        val start = size.center + Offset((-horizontalOffset).toFloat(), verticalOffset.toFloat())
        val end = size.center + Offset(horizontalOffset.toFloat(), (-verticalOffset).toFloat())
